...
const Membership = () => {
  ...
  return (
    <>
      <section className="text-gray-600 body-font overflow-hidden max-w-[1350px] mx-auto">
        <div className="container px-5 pt-10 pb-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">
              I am here to giving you best visa guidance for various aspects
              with great discounts. The price of the package is relatively low
              and affordable for you. I will be your guide from the journey
              start till the end. So, why are you waiting for? Grab your
              package.
            </p>
